   ...
   <body>
      <div class="osahan-index bg-c d-flex align-items-center justify-content-center vh-100 index-page">
         <div class="text-center">
            <a href="landing.php">
            <img src="img/logo/logo3.png" class="img-fluid shadow rounded-3">
            </a>
         </div>
      </div>
      <div class="osahan-footer fixed-bottom p-3">
         <a class="btn btn-lg w-100 d-flex align-items-center shadow text-white" href="<?php echo $routes['landing']; ?>" style="background-color: #002d47">
